...
data %>% filter(Country == "Japón") %>% ggplot(aes(x = Year, y = Energy.Flow)) +
  ...
  labs(title = "Total de Flujo Energético: Japón",
       x = "Año",
       y = "",
       caption= "Información de https://www.kaggle.com/datasets/anishvijay/global-renewable-energy-and-indicators-dataset")+
...
En cuanto a nuestro análisis de datos, la @fig-2.13 muestra que los datos con mayores emisiones de CO2 no se encuentran en los mayores niveles de producción, sin embargo, la relación es poco clara. Aunque se espera encontrar una relación inversa entre producción de energías renovables y emisiones de CO2, pues las energías renovables son energías más limpias que las generadas por otras fuentes, como los combustibles fósiles. 
