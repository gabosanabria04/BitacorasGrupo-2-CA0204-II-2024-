...
```{r}
original <- read.csv("/home/estudiante/Descargas/Herramientas/Proyecto/BitacorasGrupo-2-CA0204-II-2024-/data/complete_renewable_energy_dataset.csv")
df <- original
...
ggplot(df, aes(x = Country, fill = Energy.Type)) +
  ...
  labs(
    title = "Types of Energy in Percentage",
    subtitle = "By country",
...
ggplot(annual, aes(x = Year, y = avg_electricity_price)) +
  ...
  scale_y_continuous(breaks = c(0.2, 0.30, 0.4))
...
ggplot(annual, aes(x = Year, y = avg_production)) +
  ...
  theme_cowplot()+
  scale_x_continuous(breaks=c(2000, 2010, 2020)) +
  scale_y_continuous(breaks = c(30000, 50000, 70000))
...
ggplot(annual, aes(x = avg_production, y = avg_electricity_price))+
  ...
  scale_x_continuous(breaks = c(30000, 50000, 70000))
...
![pastebin](pastebin.png){fig-align="center" width="100%"} ![git cliff](git_cliff_1.png){fig-align="center" width="100%"} ![git cliff](git_cliff_2.png){fig-align="center" width="100%"} ![git cliff](git_cliff_3.png){fig-align="center" width="100%"} ![git summary](git_summary.png){fig-align="center" width="100%"}
