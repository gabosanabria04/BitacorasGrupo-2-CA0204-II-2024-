...
|--------------|-------------------------------------------------------------------------------------------------|
| **Introducción** | 1. Teoría A: La energía renovable como nuevo principio de autosuficiencia conectada.  <br> 2. Idea B: (Primario) <br> 3. Resultado de otro autor A (Secundario) <br> 4. Resultado de otro autor B (Secundario) <br> 5. Impacto de las energías renovables en la reducción de emisiones de CO₂ a nivel global. |
