...
Tomando en cuenta las observaciones realizadas a las bitácoras pasadas, se incorpora un caption con la fuente de la base de datos en cada gráfico. También se incorporan tags, para facilitar la identificación de los gráficos. Además, se uniforma el formato de los gráficos, de mood que todos se encuentren en español.
