...
```{r messages= FALSE, warnings= FALSE, fig.width=8}
cor(data$R.D.Expenditure, data$Investments..USD.)
linearMod <- lm(R.D.Expenditure ~ Investments..USD., data=data)
summary(linearMod)
